 ...
 * @returns {string}
 */
dlib.prototype.UUID = function (noDash = false) {
 ...
 * @returns {number}
 */
dlib.prototype.toNumber = function (number, int = false) {
  if (int) {
 ...
 * @returns {boolean}
 */
dlib.prototype.isSafe = function (value) {
 ...
 * @returns {string}
 */
dlib.prototype.combinePropsToString = function (obj, props = [], delimiter = " ", trim = true) {
 ...
 * @returns {string}
 */
dlib.prototype.stripTags = function (html) {
...
/**
 * Looks to see if a value is an integer
 * @param n The value to check
 * @returns {boolean}
 */
dlib.prototype.isInteger = function (n) {
  return !isNaN(parseInt(n)) && isFinite(n);
};

/**
 * looks to see if a value is numeric
 * @param n The value to check
 * @returns {boolean}
 */
dlib.prototype.isNumeric = function (n) {
 ...
 * @returns {object}
 */
dlib.prototype.rectToObject = function (rect) {
  return {
    left  : rect.left,
    right : rect.right,
    top   : rect.top,
 ...
 * @returns {object}
 */
dlib.prototype.removeFunctions = function (obj) {
 ...
 * @returns {object}
 */
dlib.prototype.findLast = function (array, iterator) {
 ...
 * @returns {number}
 */
dlib.prototype.findLastIndex = function (array, iterator) {
 ...
 * @returns {number}
 */
dlib.prototype.objectToDotPaths = function (source, circularReferences = []) {
  let keys = [];
 ...
 * @returns {number}
 */
dlib.prototype.objectToDotPathsAsync = function (source, circularReferences = []) {
 ...
 * @returns {object}
 */
dlib.prototype.getArgWithProp = function (args, prop) {
 ...
 */
dlib.prototype.splitEvent = function (arr) {
  let response = {
 ...
 * @returns {string}
 */
dlib.prototype.normalize = function (str, removeSpaces = false) {
 ...
 * @returns {object}
 */
dlib.prototype.userAgent = function () {
 ...
 */
dlib.prototype.concatSm = function (...arrays) {
 ...
 * @return {Array} - the compacted and concatenated array
 */
dlib.prototype.truncate = function (string, length, trailer = "") {
 ...
 * @param object
 */
dlib.prototype.removeEmptyProperties = function (object) {
 ...
 * @return component
 */
dlib.prototype.addKeys = function (component) {
  ...
  let children = React.Children.map(component.props.children, (child, index) => {
    if (!React.isValidElement(child) && !_.has(child, ["props", "children"])) return child;
 ...
 * @param array
 */
dlib.prototype.randomizeArray = function (array) {
  array        = _.clone(array);
  let newArray = [];
  while (array.length > 0) {
    newArray.push(array.splice(dlib.prototype.random(0, array.length - 1), 1));
  }
  return newArray;
};
 ...
 * @return {string}
 */
dlib.prototype.formatCurrency = function (amount, currency, locale, showCurrency = true) {
  amount   = amount || 0;
 ...
 * @return {*}
 */
dlib.prototype.escapeRegEx = function (string) {
 ...
 * @return {number}
 */
dlib.prototype.unformatCurrency = function (formattedValue, currency, locale) {
 ...
 * @param email
 */
dlib.prototype.isEmailValid = function (email, emptyIsValid = false) {
  ...
  if(!domainSuffixes.some(suffix => domain.endsWith("." + suffix))) return false;
  return true;
};

/**
 * For some reason, lodash's map function on an object isn't working, so I am manually doing it here using toPairs
 */
dlib.prototype.map = function (object) {
 ...
 * @returns {string}
 */
dlib.prototype.getDateFormatTokenType = function (token) {
  switch (token) {
    case "M":
    case "Mo":
    case "MM":
 ...
 * @returns {string}
 */
dlib.prototype.getDateFormatTokenUnit = function (token) {
  switch (token) {
    case "M":
    case "Mo":
    case "MM":
 ...
 * @returns {string}
 */
dlib.prototype.dateFormatToArray = function (format) {
 ...
 * @returns {string}
 */
dlib.prototype.dateFormatToMask = function (format) {
 ...
 * @returns {string}
 */
dlib.prototype.toTimeString = function (number, options = toTimeStringDefaults) {
 ...
 * @returns {number}
 */
dlib.prototype.trimTime = function (number) {
 ...
 * @param object
 */
dlib.prototype.objectToDate = function (object) {
 ...
 * @returns {object}
 */
dlib.prototype.differenceObj = function (objectToCompareFrom, objectToCompareTo) {
 ...
 * @returns {boolean}
 */
dlib.prototype.areChildrenEqual = function (object, other) {
...
/**
 * Looks over all the instances in the debug module and disables matched ones. This is because the default debug.disable() disables everything.
 * @param namespace
 */
dlib.prototype.disableDebugNamespace = function (namespace) {
  let instances = debug.instances;
  instances.forEach(instance => {
    if (instance.namespace.match("^" + namespace)) instance.enabled = false;
  });
};

/**
 * Looks over all the instances in the debug module and returns one that matches.
 * @param namespace
 */
dlib.prototype.getDebugNamespace = function (namespace) {
  let instances = debug.instances;
  for (let instance of instances) {
    if (instance.namespace === namespace) return instance;
  }
 ...
 * @returns {number}
 */
dlib.prototype.percent = function (percentage, maxValue = 1, minValue = 0, ascending = true) {
 ...
 * @returns {number}
 */
dlib.prototype.percentf = function (numerator, denominator, maxValue = 1, minValue = 0, ascending = true) {
 ...
 * @returns {string}
 */
dlib.prototype.toHex = function (value) {
 ...
 * @returns {number}
 */
dlib.prototype.random = function (min, max) {
 ...
 * @returns {number}
 */
dlib.prototype.toDegrees = function (rads) {
 ...
 * @returns {number}
 */
dlib.prototype.toRadians = function (degs) {
 ...
 * @returns {number}
 */
dlib.prototype.getDistanceBetweenCoords = function (x1, y1, x2, y2) {
  let dx = x2 - x1;
  let dy = y2 - y1;
 ...
 * @returns {number}
 */
dlib.prototype.getDistanceDelta = function (dx, dy) {
  return Math.sqrt((dx * dx) + (dy * dy));
};
 ...
 * @returns {number}
 */
dlib.prototype.getPointOnLine = function (x1, y1, x2, y2, distanceFromX1Y1) {
 ...
 * @returns {number}
 */
dlib.prototype.getPointOnLinePercentage = function (x1, y1, x2, y2, percentageBetweenFromX1Y1) {
  let deltaX = (x2 - x1);
  let deltaY = (y2 - y1);
 ...
 * @returns {number}
 */
dlib.prototype.getPointOnLine2D = function (a, b, distanceFromPointA) {
  let d   = b - a;
 ...
 * @returns {number}
 */
dlib.prototype.getPointOnLine2DPercentage = function (a, b, percentageFromPointA) {
  let d = (b - a);
 ...
 * @returns {number}
 */
dlib.prototype.getBezierPoint = function (x1, y1, x2, y2, cx1, cy1, cx2, cy2, step, steps) {
 ...
 * @returns {number}
 */
dlib.prototype.getBezierPointPercentage = function (x1, y1, x2, y2, cx1, cy1, cx2, cy2, percentage) {
 ...
 * @returns {number}
 */
dlib.prototype.getBezier2D = function (p1, p2, cp1, cp2, step, steps) {
 ...
 * @returns {number}
 */
dlib.prototype.getBezier2DPercentage = function (p1, p2, cp1, cp2, percentage) {
  let C = 3 * (cp1 - p1);
  let B = 3 * (cp2 - cp1) - C;
  let A = p2 - p1 - C - B;
 ...
 * @returns {object}
 */
dlib.prototype.colorToRGBA = function (color) {
  ...
  if (color.startsWith("rgb")) {
    ...
    switch (color.length) {
      case 8:
        includeAlpha = true;
        color        = parseInt(color, 16);  // 2 digit with alpha
        break;
      case 6:
        color = parseInt(color + "FF", 16); // 2 digit without alpha
        break;
      case 4:
        includeAlpha = true;
        color        = parseInt(color[0] + color[0] + color[1] + color[1] + color[2] + color[2] + color[3] + color[3], 16); // 1 digit with alpha
        break;
      case 3:
        color = parseInt(color[0] + color[0] + color[1] + color[1] + color[2] + color[2] + "FF", 16); // 1 digit outout alpha
        break;
      default:
        return undefined;
    }

    newColor.r = color >> 24 & 255;
    newColor.g = color >> 16 & 255;
    newColor.b = color >> 8 & 255;
    if (includeAlpha) newColor.a = (color >> 255) / 255;
  }
  return newColor;
};
 ...
 * @returns {string}
 */
dlib.prototype.rgbaToHex = function (red, green, blue, alpha) {
 ...
 * @returns {string}
 */
dlib.prototype.rgbaToString = function (color) {
  if (!color) color = {};
 ...
 */
dlib.prototype.hexToRGBA = function (hexColor, a) {
 ...
 * @returns {string}
 */
dlib.prototype.colorBlend = function (percentage, from, to) {
  ...
  let toColor   = _.isObjectLike(to) && _.has(to, ["r"]) && _.has(to, ["g"]) && _.has(to, ["b"]) ? color : this.colorToRGBA(to);
 ...
 */
dlib.prototype.getBrightness = function (color) {
 ...
 */
dlib.prototype.isDark = function (color, brightnessOffset = 0) {
 ...
 * @returns {string}
 */
dlib.prototype.resizeImage = function (imgSource, targetWidth, targetHeight, keepAspectRatio = true) {
  return new DPromise((resolve, reject, abort) => {
    let cancelled = false;
 ...
 * @returns {object}
 */
dlib.prototype.getBoundingClientRect = (element) => {
 ...
 */
dlib.prototype.rect = class rect {
 ...
 * @returns {object}
 */
dlib.prototype.getViewport = function () {
...
dlib.prototype.focusNextElement = function () {
 ...
 * @returns {string}
 */
dlib.prototype.getFileSizeBaseUnit = function (size) {
 ...
 * @returns {string}
 */
dlib.prototype.getFileSizeString = function (size, unit = "b", decimals = 0, addUnit = true) {
  unit = _.toUpper(unit);
 ...
 * @returns {array}
 */
dlib.prototype.pathSorter = function (sep = "/") {
...
dlib.prototype.sort = function (arr, locale, path = undefined, caseInsensitive = false, trim = false) {
 ...
 * @returns {string}
 */
dlib.prototype.loadFileAsync = function (path) {
  return new Promise((resolve, reject) => {
...
dlib.prototype.importFiles = function (files) {
  let imported = {};
  let keys     = files.keys();
 ...
 */
dlib.prototype.copyToClipboard = function (str) {
...
module.exports = new dlib();
// export default new dlib();
