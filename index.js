...
dlib.getCountries = function() {
  ...
  console.log("iso_3166_2:", iso_3166_2);

  _.map(iso_3166_2, (value, key) => {
    console.log("dlib - getCountries - value:", value, "key:", key);

    return countries.push({code: key, name: value.name})
  });
  return countries;
};
